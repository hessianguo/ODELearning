...
dt = T[1] - T[0]
X_dot_tv_1 = TVRegDiff(X_ns[0,:], 50, 2e-6, scale='small', ep=1e-6, dx=dt, plotflag=0)
X_dot_tv_2 = TVRegDiff(X_ns[1,:], 50, 2e-6, scale='small', ep=1e-6, dx=dt, plotflag=0)
X_dot_tv_3 = TVRegDiff(X_ns[2,:], 50, 2e-6, scale='small', ep=1e-6, dx=dt, plotflag=0)
