...
plt.plot(T1, X_fit[1], '--b', label='fitted $x_2$')
plt.legend(loc='upper left')
plt.xlabel('$t$', fontsize=20)
plt.ylabel('$x_i$', fontsize=20)
plt.tight_layout()
plt.subplot(1, 2, 2)
plt.plot(T, Dx[0], '-m', label='true $\dot{x}_1$')
plt.plot(T, Dx[1], '-b', label='true $\dot{x}_2$')
plt.plot(T1, X_dot[0], '--', c='green', label='fitted $\dot{x}_1$')
plt.plot(T1, X_dot[1], '--', c='orange', label='fitted $\dot{x}_2$')
plt.legend(loc='upper left')
plt.xlabel('$t$', fontsize=20)
