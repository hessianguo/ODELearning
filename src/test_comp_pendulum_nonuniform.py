...
filename = f"numerical_errors_pendulum_{nsr:.2e}.txt"
...
filename = f"derivx_rkhs_pendulum_nsr_{nsr:.2e}.pdf"
...
plt.xlabel('$t$', fontsize=10)
plt.ylabel('$\\dot{x}_1$', fontsize=10)
filename = f"derivx_fd_pendulum_nsr_{nsr:.2e}.pdf"
plt.savefig(filename, format="pdf", bbox_inches="tight")
plt.show()
...
plt.xlabel('$t$', fontsize=10)
plt.ylabel('$\\dot{x}_1$', fontsize=10)
filename = f"derivx_tv_pendulum_nsr_{nsr:.2e}.pdf"
plt.savefig(filename, format="pdf", bbox_inches="tight")
plt.show()
...
filename = f"noisedata_x_pendulum_nsr_{nsr:.2e}.pdf"
plt.savefig(filename, format="pdf", bbox_inches="tight")
plt.show()
plt.plot(T, X_data[0], '--b', label='true x1')
...
plt.xlabel('$t$', fontsize=10)
plt.ylabel('$x_1$', fontsize=10)
filename = f"denoisedata_x_pendulum_nsr_{nsr:.2e}.pdf"
plt.savefig(filename, format="pdf", bbox_inches="tight")
plt.show()